        ...
        <main class="font-fam text-gray-800 bg-white">
            ...
            <div class="max-w-6xl mx-auto p-8">
               <section id="overview" class="mb-16 p-8 bg-white">
                    <h1 class="text-[#501214] text-3xl mb-6 pb-2 border-b-2 border-gray-300">Faculty Project Collaboration Platform</h1>
                    <p class="mb-4">Join a university-wide initiative that connects students with real-world faculty projects,
                ...
                <section class="bg-gray-100 text-center p-12 my-8">
                    <h2 class="text-[#501214] text-3xl mb-4">Start Your Journey Today</h2>
                    <p class="mb-6">Sign up, showcase your skills, and get matched with exciting projects that align with your career goals.</p>
                    <button onClick={handleLoginClick} className="text-gray-800 font-medium hover:text-[#501214]">Join Now</button>
                </section>

                <section id="benefits" class="bg-gray-100 text-center p-12 my-8">
                    <h2 class="text-[#501214] text-4xl mb-6 pb-2 border-b-2 border-gray-300">Is This Right for Me?</h2>
                    <div class="space-y-6">
                        <div class="mb-6">
